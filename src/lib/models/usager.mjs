...
export const UsagerSchema = new Schema(
	{
		prenom: {
			...
			minLength: [
				cnt.nom.longueurMin,
				`Le prénom doit contenir entre ${cnt.nom.longueurMin} et ${cnt.nom.longueurMax} caractères`,
			],
			maxLength: [
				cnt.nom.longueurMax,
				`Le prénom doit contenir entre ${cnt.nom.longueurMin} et ${cnt.nom.longueurMax} caractères`,
		...
		nom: {
			...
			minLength: [
				cnt.nom.longueurMin,
				`Le nom doit contenir entre ${cnt.nom.longueurMin} et ${cnt.nom.longueurMax} caractères`,
			],
			maxLength: [
				cnt.nom.longueurMax,
				`Le nom doit contenir entre ${cnt.nom.longueurMin} et ${cnt.nom.longueurMax} caractères`,
		...
		mdp: {
			...
			minLength: [
				cnt.mdp.longueurMin,
				`Le mot de passe doit contenir entre ${cnt.mdp.longueurMin} et ${cnt.mdp.longueurMax} caractères`,
			],
			maxLength: [
				cnt.mdp.longueurMax,
				`Le mot de passe doit contenir entre ${cnt.mdp.longueurMin} et ${cnt.mdp.longueurMax} caractères`,
		...
		telephone: {
			...
			match: [
				cnt.telephone.regex,
				"Le numéro de téléphone est invalide. Veuillez entrer selon le format 555-555-5555",
			],
		},
		estAdmin: {
			type: Boolean,
